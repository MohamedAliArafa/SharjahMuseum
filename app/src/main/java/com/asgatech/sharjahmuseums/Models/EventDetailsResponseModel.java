...
public class EventDetailsResponseModel extends RealmObject{
    ...
    @Expose
    private RealmList<EventImage> eventImages = null;
    ...
    public RealmList<EventImage> getEventImages() {
        return eventImages;
    }

    public void setEventImages(RealmList<EventImage> eventImages) {
