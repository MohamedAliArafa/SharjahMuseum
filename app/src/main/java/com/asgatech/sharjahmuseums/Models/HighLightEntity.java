 ...
 */
public class HighLightEntity extends RealmObject implements Parcelable {
    /**
     * HightlightID : 1
     * Mus_ID : 1
     * Title : jkjk
    ...
    public static final Creator<HighLightEntity> CREATOR = new Creator<HighLightEntity>() {
        @Override
        public HighLightEntity createFromParcel(Parcel in) {
            return new HighLightEntity(in);
        }

        @Override
        public HighLightEntity[] newArray(int size) {
            return new HighLightEntity[size];
        }
    };
    ...
    protected HighLightEntity(Parcel in) {
